...
1≤Hi≤999,9991≤Hi​≤999,999
0≤Ai<Bi≤1,000,0000≤Ai​<Bi​≤1,000,000
Sample test case #1
...
You should pick the second conveyor belt and cause it to run to the right. Packages falling at x-coordinates in the intervals [0,100,000][0,100,000] and [800,000,1,000,000][800,000,1,000,000] will fall directly to the ground (with 0 horizontal travel distance), while packages falling at x-coordinates in the interval (400,000,800,000)(400,000,800,000) will have an average horizontal travel distance of 200,000200,000 units. This leaves packages falling at x-coordinates in the interval (100,000,400,000](100,000,400,000], which will have an average horizontal travel distance of either 150,000150,000 units (if the first conveyor belt runs to the left) or 350,000350,000 units (if it runs to the right). This yields an overall expected horizontal travel distance of 0∗0.3+200,000∗0.4+((150,000+350,000)/2)∗0.3=155,0000∗0.3+200,000∗0.4+((150,000+350,000)/2)∗0.3=155,000, which is the minimum achievable expected horizontal travel distance.
The second case is depicted above. In it, you should pick the third conveyor belt and cause it to run to the left.
 */
public class conveyorChaos {
