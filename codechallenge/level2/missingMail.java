 ...
 * You are the manager of a mail room which is frequently subject to theft. A period of NN days is about to occur, such that on the iith day, the following sequence of events will occur in order:
    ...
    A package with a value of ViVi​ dollars will get delivered to the mail room (unless Vi=0Vi​=0, in which case no package will get delivered).
...
Note that you're aware of the delivery schedule V1..NV1..N​, but can only observe the state of the mail room when you choose to enter it, meaning that you won't immediately be aware of whether or not packages were stolen at the end of any given day.
